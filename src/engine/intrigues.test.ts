...
describe('le moteur d’intrigues', () => {
  ...
  it('un imprévu et une carte d’intrigue ne sortent jamais en même temps', () => {
    ...
    etat.nuit = { numero: 9, comptes: comptesVides(), tresorerieAvant: 0, tresorerieApres: 0, retraitReserve: 0, empruntRecu: 0, servis: 0, perdus: 0, reputationDebut: 25, meilleurAvis: null, pireAvis: null, reserve: 0, imprevus: 0 };
