...
function soiree(champs: Partial<EtatJeu> = {}): EtatJeu {
  ...
  etat.equipes.bar = 1;
  etat.nuit = { numero: 9, comptes: comptesVides(), tresorerieAvant: 0, tresorerieApres: 0, retraitReserve: 0, empruntRecu: 0, servis: 0, perdus: 0, reputationDebut: 30, meilleurAvis: null, pireAvis: null, reserve: 0, imprevus: 0 };
  return { ...etat, ...champs };
}
