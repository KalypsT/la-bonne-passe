...
export const TEXTES = {
  ...
  bilan: {
    ...
    postesDepenses: {
      ...
      emprunts: 'Échéances des emprunts',
      impots: 'Impôt du trimestre',
      gestion: 'Commission de Josée',
      agios: 'Agios',
  ...
  semaine: {
    ...
    projectionDetail: 'Si la semaine prochaine ressemble à celle-ci, travaux à part : mensualités, échéances des emprunts et remboursements compris, dettes déduites.',
